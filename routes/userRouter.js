...
router.post("/signup/recruiter", userController.newJobOffers, userController.redirectView); // POST job offer data
...
//for recruiter user.
router.get("/user/:id/create_offers", userController.renderNewJobOffer);
